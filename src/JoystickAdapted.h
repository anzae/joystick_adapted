...
/*
Update by Anae on May 2023:
- No steering, brake, rudder, throttle, acceleration, hat switches
- Function getForce(int8_t forces, int len) writes the exact bytes received on vector forces
- No force calculator, but output report still has length 18
*/
